      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <form class="needs-validation theme-form" novalidate="" onsubmit="enviar();"
            action="{{ route('beneficiarios.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="inputApellidos" type="text" required name="apellidos"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input class="datepicker-here form-control digits" required data-lenguage="es" id="inputfnac"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="inputRegistrosocial" type="text" required name="registrosocial"
                      placeholder="1252831">
                    <div class="valid-feedback">¡Luce bien!</div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="inputPorcentaje" type="number" name="porcentaje" required
                      placeholder="99">
                    <div class="valid-feedback">¡Luce bien!</div>
                  </div>
                </div>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="inputDireccion" type="text" name="direccion" required
                      placeholder="avda. siempre viva">
                    <div class="valid-feedback">¡Luce bien!</div>
                  </div>
                </div>
            ...
            <div class="card-footer text-end">
              <button class="btn btn-primary" id="btn" type="submit">Crear</button>
